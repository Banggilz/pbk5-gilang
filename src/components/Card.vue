    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center mt-2.5 mb-5">
            ...
            <span class="flex flex-row items-end gap-2">
                <p class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">5.0</p>
                <p class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ item.type }}</p>
            </span>
        </div>
